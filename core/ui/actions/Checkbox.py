...
class Checkbox:
    ...
    def is_displayed(self):
        ...
        if self._element:
            ...
            logger.info("Checkbox button displayed value ["+value+"]")
        else:
            logger.error("Unable to Display Value Checkbox WebElement is None.")
        return value
    ...
    def is_selected(self):
        ...
        if self._element:
            ...
            logger.info("Checkbox button selected value [" + value + "]")
        else:
            logger.error("Unable to Selected Value Checkbox WebElement is None.")
        return value
    ...
    def set_value(self, value: bool):
        ...
        if self._element:
            ...
            logger.error("Unable to Select Checkbox WebElement is None.")
