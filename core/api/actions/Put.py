...
class Put:
    ...
    def send(self):
        ...
        logger.info(
            f"Sending PUT to: {url} With data: {self.data}, JSON: {self.json_data}, files: {self.files}, headers: {self.headers}")
    ...
    def get_response_json(self):
        """Get the JSON response from the PUT request."""
