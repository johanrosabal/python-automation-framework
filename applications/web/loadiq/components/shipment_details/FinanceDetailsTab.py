...
logger = setup_logger('FinanceDetailsTab')


class FinanceDetailsTab(BasePage):

    def __init__(self, driver):
        """
        Initialize the FinanceDetailsTab instance.
        """
    ...
    def get_instance(cls):
        if not hasattr(cls, '_instance'):
            cls._instance = FinanceDetailsTab(BaseApp.get_driver())
