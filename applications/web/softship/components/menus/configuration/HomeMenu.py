...
class HomeMenu(BasePage):
    ...
    def __init__(self, driver):
        ...
        self.__nav_security = (By.XPATH, "//span[@class='ng-binding ng-scope' and text()='SECURITY']", "SECURITY Menu Option")
        self.__nav_utilities = (By.XPATH, "//span[@class='ng-binding ng-scope' and text()='UTILITIES']", "UTILITIES Menu Option")
    ...
    @allure.step("Menu SECURITY")
    def menu_security(self, pause: int = 0):
        self._load_page(self.__nav_security, pause)
        return self

    @allure.step("Menu UTILITIES")
    def menu_utilities(self, pause: int = 0):
        self._load_page(self.__nav_utilities, pause)
        return self
