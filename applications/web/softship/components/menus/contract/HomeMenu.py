...
class HomeMenu(BasePage):
    ...
    def __init__(self, driver):
        ...
        self.__nav_contracts = (By.XPATH, "//span[@class='ng-binding ng-scope' and text()='Contracts']", "Contracts Menu Option")
    ...
    @allure.step("Menu Contracts")
    def menu_contracts(self, pause: int = 0):
        self._load_page(self.__nav_contracts, pause)
        return self
