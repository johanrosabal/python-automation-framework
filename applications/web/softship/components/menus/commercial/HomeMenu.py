...
class HomeMenu(BasePage):
    ...
    def __init__(self, driver):
        ...
        self.__nav_voyage = (By.XPATH, "//span[@class='ng-binding ng-scope' and text()='Voyage']", "Voyage Menu Option")
        self.__nav_quote_rate = (By.XPATH, "//span[@class='ng-binding ng-scope' and text()='Quote / Rate']", "Quote / Rate Menu Option")
    ...
    @allure.step("Menu Voyage")
    def menu_voyage(self, pause: int = 0):
        self._load_page(self.__nav_voyage, pause)
        return self

    @allure.step("Menu Quote / Rate")
    def menu_quote_rate(self, pause: int = 0):
        self._load_page(self.__nav_quote_rate, pause)
        return self
