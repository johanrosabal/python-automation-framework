...
logger = setup_logger('VoyageMenu')


class VoyageMenu(BasePage):
    ...
    def __init__(self, driver):
        ...
        # Relative URL
        self.relative = "/Voyage/Home/VoyageHome"
        # Name
        self._name = self.__class__.__name__
        self._module_url = None
        # Locator definitions
        self.__link_update_voyage = (By.XPATH, "//a[text()='Update Voyage']", "Link Update Voyage")
    ...
    def menu_update_voyage(self, pause: int = 0):
        self._load_page(self.__link_update_voyage, pause)
        return self
